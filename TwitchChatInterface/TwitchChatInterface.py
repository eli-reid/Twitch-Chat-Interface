...
class TwitchChatInterface(object):
    ...
    class On():
        ...
        """ 
            ...
            using on.event you can register listen for any event in the twitch irc responses

            *EXAMPLE*:

            :function: on.eventConnect(func) 

            :params func: is function pointer

            .. code-block:: python
                        
                def myCallbackFunc(sender, obj):
        ...
        class MsgIdEvent:
            ...
            def USAGE_UNMOD(func) ->None:
                """ 
                Register a callback function for this event: WHISPER_INVALID_LOGIN

                :params func: takes a function pointer as  input argument
                ...
                .. code-block:: python
                    ...
                    WHISPER_INVALID_LOGIN(myCallbackFunc)
